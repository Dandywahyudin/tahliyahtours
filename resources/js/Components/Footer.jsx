            ...
            <div className="grid md:grid-cols-5 gap-8">
                <div>
                    <Link href="/" className="flex items-center space-x-2 mb-4 hover:opacity-80 transition-opacity">
                        ...
                        <div>
                            <h3 className="text-lg font-bold">TAHLIYAH</h3>
                            <p className="text-sm text-gray-400">Tours & Travel</p>
                        </div>
                    </Link>
                    <p className="text-gray-400">
                        Mewujudkan perjalanan ibadah yang berkesan bersama pembimbing terpercaya.
                    </p>
                </div>
                <div>
                ...
                <ul className="space-y-2 text-gray-400">
                        <li>
                            <a href="tel:+622112345678" className="hover:text-orange-400 transition-colors">
                                +62 21 1234 5678
                            </a>
                        </li>
                        <li>
                            <a href="mailto:info@tahliyahtours.com" className="hover:text-orange-400 transition-colors">
                                info@tahliyahtours.com
                            </a>
                        </li>
                        <li>
                            <button
